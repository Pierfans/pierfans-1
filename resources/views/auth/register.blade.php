                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-4 mt-6">
                        ...
                        <div class="flex items-start">
                            <input
                                ...
                                name="terms"
                                required
                                class="mt-1 mr-2 rounded border-gray-300 text-[#14d1bc] focus:ring-[#14d1bc]"
                            >
                            <label for="terms" class="text-sm text-gray-600">
                                Concordo com o processamento de dados pessoais
                                <a href="#" class="text-[#14d1bc] hover:text-[#0e9486] underline">Termos e Condições</a>
                                e
                                <a href="#" class="text-[#14d1bc] hover:text-[#0e9486] underline">política de Privacidade</a>
                            </label>
                        </div>
