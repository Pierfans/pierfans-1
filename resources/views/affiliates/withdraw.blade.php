...
<head>
    ...
    <title>Saque de Afiliados - {{ config('app.name', 'Laravel') }}</title>
...
<body class="bg-[#FDFDFC] text-[#1b1b18] min-h-screen">
    ...
    <div class="pt-0 md:pt-16 pb-16 md:pb-0">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-[#1b1b18] mb-2">Saque de Afiliados</h1>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            window.submitWithdraw = function(e) {
                ...
                fetch('{{ route("affiliates.withdraw.store") }}', {
                    method: 'POST',
                    headers: {
        ...
        window.openEditBankAccountModal = function(accountId) {
            ...
            fetch(`/affiliates/bank-account/${accountId}`)
        ...
        window.closeBankAccountModal = function() {
            ...
            window.submitBankAccount = function(e) {
                ...
                const url = accountId 
                    ? `/affiliates/bank-account/${accountId}`
                    : '{{ route("affiliates.bank-account.store") }}';
